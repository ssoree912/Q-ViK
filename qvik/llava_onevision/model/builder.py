...
import torch
from qvik.llava_onevision.model import *
from qvik.llava_onevision.constants import DEFAULT_IMAGE_PATCH_TOKEN, DEFAULT_IM_START_TOKEN, DEFAULT_IM_END_TOKEN
...
def load_pretrained_model(model_path, model_base, model_name, load_8bit=False, load_4bit=False, device_map="auto", attn_implementation="sdpa", customized_config=None, overwrite_config=None, **kwargs):
    ...
    if "llava" in model_name.lower() or is_multimodal:
        ...
        if "lora" in model_name.lower() and model_base is not None:
            ...
            if "mixtral" in model_name.lower():
                from qvik.llava_onevision.model.language_model.llava_mixtral import LlavaMixtralConfig
                ...
                from qvik.llava_onevision.model.language_model.llava_mistral import LlavaMistralConfig
                ...
                from qvik.llava_onevision.model.language_model.llava_gemma import LlavaGemmaConfig
                ...
                from qvik.llava_onevision.model.language_model.llava_llama import LlavaConfig
            ...
            if "mixtral" in model_name.lower():
                ...
                if "moe" in model_name.lower() or "A14B" in model_name.lower():
                    from qvik.llava_onevision.model.language_model.llava_qwen_moe import LlavaQwenMoeConfig
                    if overwrite_config is not None:
                    ...
                    from qvik.llava_onevision.model.language_model.llava_qwen_training_free import LlavaQwenTrainingFreeConfig
                    if overwrite_config is not None:
                    ...
                    from qvik.llava_onevision.model.language_model.llava_qwen import LlavaQwenConfig
                    if overwrite_config is not None:
