...
class SigLipVisionTower(nn.Module):
    ...
    def load_model(self, device_map=None):
        ...
        # NOTE: do NOT call SigLipVisionModel.from_pretrained here. Newer
        # transformers loads HF weights into meta tensors with low_cpu_mem_usage,
        # producing "copying ... to a meta parameter ... no-op" warnings and
        # leaving the vision tower effectively uninitialized. Initialize the
        # architecture from config and let the parent LLaVA checkpoint populate
        # the actual weights via its own state_dict load.
